<div id="content">
    <section class="main padder">
        ...
        <h4><i class="icon-dropbox"></i>Edit Stock <small></small></h4>
        <form class="form-horizontal" method="post" data-validate="parsley" action="<?php echo base_url('backend/stock/edit/' . $product_stock_id . '/' . $product_id); ?>" enctype="multipart/form-data">      
            <!-- booking table -->
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="code" placeholder="Stock Code" data-required="true" class="form-control"
                                   value="<?php echo isset($product_stock_code) ? $product_stock_code : ''; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="checkbox">
                                <label class="checkbox-custom">
                                    <input type="checkbox" name="is_promotion" id="is_promotion" value="1" <?php echo $is_promotion ? 'checked="checked"' : ''; ?>>
                                    <i class="icon-unchecked"></i>
                                    Promotion
                                </label>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="checkbox">
                                <label class="checkbox-custom">
                                    <input type="checkbox" name="is_early_bird" id="is_early_bird" value="1" <?php echo $is_early_bird ? 'checked="checked"' : ''; ?>>
                                    <i class="icon-unchecked"></i>
                                    Early Bird
                                </label>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-1" style="width: auto; padding: 0px; font-size: 19px;float:left">
                            <span class="control-label">:</span>
                        </div>
                        <div class="col-xs-2" style="width: auto;float:left">
                    ...
                    <?php
                    /*
                      if (strtotime($product_stock_depart_duration) <= 0)
                      {
                      $product_stock_depart_duration = $product_stock_depart_at;
                      }
                     * 
                     */
                    ?>
                    ...
                    <?php
                    /*
                      if (strtotime($product_stock_arrive_duration) <= 0)
                      {
                      $product_stock_arrive_duration = $product_stock_arrive_at;
                      }
                     * 
                     */
                    ?>
                        ...
                        <div class="col-lg-4">
                            <select name="airline" class="form-control">
                                ...
                                <?php foreach ($airlines as $airline): ?>
                                    <option value="<?php echo $airline->airline_id; ?>" <?php echo $product_stock_airline_id == $airline->airline_id ? 'selected="selected"' : ''; ?>><?php echo $airline->airline_code; ?>-<?php echo $airline->airline_title_th; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4">
                                <select name="hotel" class="form-control">
                                    ...
                                    <?php foreach ($hotels as $hotel): ?>
                                        <option value="<?php echo $hotel->hotel_id; ?>" <?php echo $product_stock_hotel_id == $hotel->hotel_id ? 'selected="selected"' : ''; ?>><?php echo $hotel->hotel_title_th; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="stock_booked" placeholder="Booked" class="form-control small" style="display: inline; width: 80px;"
                                   value="<?php echo isset($product_stock_booked) ? $product_stock_booked : ''; ?>"> / <input type="text" name="stock_total" placeholder="Total" data-required="true" class="form-control small"  style="display: inline;  width: 80px;"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="advanced_price" placeholder="Advanced Price" class="form-control" value="<?php echo isset($product_stock_advanced_price) ? $product_stock_advanced_price : ''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="direct_bank" value="1" <?php echo isset($payment_method['direct']) && $payment_method['direct'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="bill_bank" value="1" <?php echo isset($payment_method['bill_bank']) && $payment_method['bill_bank'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="bill_bigc" value="1" <?php echo isset($payment_method['bill_bigc']) && $payment_method['bill_bigc'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="bill_thp" value="1" <?php echo isset($payment_method['bill_thp']) && $payment_method['bill_thp'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="kbank" value="1" <?php echo isset($payment_method['kbank']) && $payment_method['kbank'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="number" step="any" name="kbank_rate" placeholder="Charge Rate" class="form-control" value="<?php echo $payment_method['kbank_rate'] ? $payment_method['kbank_rate'] : '2.5'; ?>">
                                    </div>
                                    <div class="col-lg-4">
                                        <?php echo form_dropdown('kbank_type', array('%' => '%', 'บาท' => 'บาท'), $payment_method['kbank_type'], 'class="form-control"'); ?>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox-custom">
                                        <input type="checkbox" name="bangkok_bank" value="1" <?php echo isset($payment_method['bangkok_bank']) && $payment_method['bangkok_bank'] ? 'checked="checked"' : ''; ?>>
                                        <i class="icon-unchecked"></i>
                                        Active
                                    </label>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="number" step="any" name="bangkok_bank_rate" placeholder="Charge Rate" class="form-control" value="<?php echo $payment_method['bangkok_rate'] ? $payment_method['bangkok_rate'] : '2.5'; ?>">
                                    </div>
                                    <div class="col-lg-4">
                                        <?php echo form_dropdown('bangkok_bank_type', array('%' => '%', 'บาท' => 'บาท'), $payment_method['bangkok_type'], 'class="form-control"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
